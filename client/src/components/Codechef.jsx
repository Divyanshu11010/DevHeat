...
const CodeChefStatsDisplay = ({ data }) => {
  ...
  return (
    <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-4 sm:p-6 xl:p-8 text-gray-200 bg-gray-900">

      {/* Current Rating */}
      <div className="shadow-md rounded-2xl p-6 flex flex-col items-center bg-gray-900">
        ...
        <p className="mt-3 text-sm sm:text-base text-gray-400">Stars: {stars}</p>
      </div>
      ...
      {/* Rank Info */}
      <div className="shadow-md rounded-2xl p-6 bg-gray-900">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-sm mt-1 text-gray-400">#{globalRank}</p>
          </div>
          <div>
            <p className="text-sm font-medium text-gray-300">Country Rank</p>
            <div className="w-full h-3 bg-gray-700 rounded">
              <div
            ...
            <p className="text-sm mt-1 text-gray-400">#{countryRank}</p>
          </div>
        </div>
      </div>

      {/* Contest Table */}
      <div className="shadow-md rounded-2xl p-6 col-span-1 sm:col-span-2 lg:col-span-3 bg-gray-900">
      ...
      <div className="shadow-md rounded-2xl p-6 col-span-1 sm:col-span-2 lg:col-span-3 bg-gray-900">
        ...
        <p className="text-xs text-gray-400 mt-2">Color represents activity level</p>
      </div>
    </div>
  );
};
